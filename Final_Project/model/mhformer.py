...
class Model(nn.Module):
    def __init__(self, args):
        ...
        self.Transformer_encoder_1 = Transformer_encoder(5, args.frames, args.frames*2, length=2*args.n_joints, h=9)
        self.Transformer_encoder_2 = Transformer_encoder(5, args.frames, args.frames*2, length=2*args.n_joints, h=9)
        self.Transformer_encoder_3 = Transformer_encoder(5, args.frames, args.frames*2, length=2*args.n_joints, h=9)
